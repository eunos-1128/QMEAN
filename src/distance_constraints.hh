...
namespace qmean{
  ...
  std::vector<float> CalculateClusterSeqSim(const ost::seq::AlignmentHandle& msaln, const std::vector<std::vector<int> >& cluster, ost::seq::alg::SubstWeightMatrixPtr subst);
  ...
  DCData FillDCData(const ost::seq::AlignmentHandle& msaln,const std::vector<std::vector<int> >& cluster,const std::vector<String>& filenames,
                    ost::seq::alg::SubstWeightMatrixPtr subst, unsigned short dist_cutoff, int exp_factor);
